package com.rm.book.auth;

import com.rm.book.role.RoleRepository;
import com.rm.book.security.JwtService;
import com.rm.book.user.Token;
import com.rm.book.user.TokenRepository;
import com.rm.book.user.User;
import com.rm.book.user.UserRepository;
...
public class AuthenticationService {
    ...
    public void register(RegistrationRequest request) throws MessagingException {
        var userRole = roleRepository.findByName("USER").orElseThrow(() -> new IllegalStateException("ROLE USER was not initializaed"));
