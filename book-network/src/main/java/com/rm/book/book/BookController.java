...
public class BookController {
    ...
    @GetMapping("/borrowed")
    public ResponseEntity<PageResponse<BorrowedBookReponse>> findAllBorrowedBooks(@RequestParam(name = "page", defaultValue = "0", required = false) int page,
                                                                          @RequestParam(name = "size", defaultValue = "10", required = false) int size,
                                                                          Authentication connectedUser) {
    ...
    @GetMapping("/returned")
    public ResponseEntity<PageResponse<BorrowedBookReponse>> findAllReturnedBooks(@RequestParam(name = "page", defaultValue = "0", required = false) int page,
                                                                                  @RequestParam(name = "size", defaultValue = "10", required = false) int size,
                                                                                  Authentication connectedUser) {
